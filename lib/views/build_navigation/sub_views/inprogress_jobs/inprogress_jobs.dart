...
import 'inprogress_jobs_controller.dart';
...
class InprogressJobs extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(InprogressJobsController());
    return BuildViewWithBackground(
      ...
      child: Column(
        ...
        children: [
          ...
          BuildSizedBox(),
          Expanded(
            child: GetBuilder<InprogressJobsController>(
              builder: (controller) {
                    ...
                    builder: (_, snap) {
                      if (snap.hasData) {
                        if (snap.data.isEmpty) {
                          return Center(
                              child: BuildText('No inprogress jobs found',
                                  color: AppColors.white,
                        ...
                        return ListView.separated(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              return BuildJobTile(
                                job,
                                onTap: () =>
                                    controller.toInprogressJobDetails(job),
                              );
                            });
