...
import 'bidded_job_details_controller.dart';

class BiddedJobDetails extends StatelessWidget {
  const BiddedJobDetails({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(BiddedJobDetailsController());
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        BuildText(
                          'Note:\nIf you are selected for this job, you\ll see this job in progress section and if customer doesn\'t  selects you this job listing will not visible.',
                          size: 1.6,
                        ),
                      ],
                    )),
